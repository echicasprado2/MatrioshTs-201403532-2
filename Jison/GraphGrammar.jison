...
DECLARATION: TYPE_DECLARATION  L_ID TYPE_VARIABLE PUNTO_Y_COMA                                             { $$ = new NodeGraphAST("DECLARACION",NumberNode.getNumber()); $$.children.push($1,$2,$3); }
        ...
        |    TYPE_DECLARATION  L_ID TYPE_VARIABLE L_DIMENSION '=' ACCESS PUNTO_Y_COMA                      { $$ = new NodeGraphAST("DECLARACION_ARRAY",NumberNode.getNumber()); $$.children.push($1,$2,$3,$4,new NodeGraphAST("=",NumberNode.getNumber()),$6); }
